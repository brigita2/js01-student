...
/*
Užduotis 5
Hidroeleketrinėje yra 19 generatorių. 
Pirmi 4 gamina po 62 MW, likusieji 15 - po 124 MW. 
Inžinieriai paprašė tavęs sukurti du ciklus (loops), kurie vienas po kito įjungia visus 19 generatorių ir 
atspausdina generuojamų MW skaičių. Pirmiems 4 generatoriams panaudok while loop, likusiems 15 - for loop. 
...
while (currentGen <= 4) {
    ...
    totalMW += 64;
    let producesMW = 64;
    console.log(`Generatorius #${count} įjungtas, pridėjo ${producesMW} MW, viso generuojama ${totalMW} MW!`)
    currentGen++;
}
console.log(totalMW);
console.log(count);
...
/*
Užduotis 6
Keli pakeitimai JS 05 užduočiai. 
Veikia tik lyginiai generatoriai. 
Panaudok tik vieną for loop. 
